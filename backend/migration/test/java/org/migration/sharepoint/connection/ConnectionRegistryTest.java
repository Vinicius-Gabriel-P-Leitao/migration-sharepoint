...
class ConnectionRegistryTest {
  ...
  void shouldRejectArbitraryString() {
    assertThatThrownBy(() -> registry.register("BAD", "Bad", "not-a-url"))
        .isInstanceOf(BadRequestException.class);
  }

  @Test
  void shouldRejectEmptyUrl() {
    assertThatThrownBy(() -> registry.register("BAD", "Bad", "   "))
        .isInstanceOf(BadRequestException.class);
  }
  ...
  void shouldThrowConflictOnDuplicateKey() {
    registry.register("MYSQL_TEST", "MySQL", "jdbc:mysql://localhost:3306/db");
    assertThatThrownBy(
            () -> registry.register("MYSQL_TEST", "MySQL 2", "jdbc:mysql://other:3306/db"))
  ...
  void shouldRemoveExistingConnection() {
    ...
    assertThatThrownBy(() -> registry.resolveUrl("MYSQL_TEST"))
        .isInstanceOf(NotFoundException.class);
  }
