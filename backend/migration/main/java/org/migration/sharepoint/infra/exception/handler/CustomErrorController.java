...
/**
 * Controller personalizado para lidar com erros mapeados para /error. Garante
 * que rotas de API (/v1/**) sempre retornem JSON, mesmo para erros de
 * infraestrutura.
 */
@Controller
public class CustomErrorController implements ErrorController {
    ...
    public ResponseEntity<?> handleError(HttpServletRequest request) {
        ...
        // NOTE: Todos os erros não mapeados que chegam aqui (como 404 estritos do boot)
        // retornam JSON.
