...
public class WriterConnectionPool implements DisposableBean {
  ...
  /**
   * Extrai user/password da JDBC URL e os remove dela, para que o HikariCP os receba via
   * setUsername/setPassword. Suporta dois formatos:
   *
   * <ul>
  ...
  private ParsedUrl parseCredentials(String jdbcUrl) {
    ...
    if (queryStart >= 0) {
      ...
      if (username != null || password != null) {
        ...
        String cleanUrl = newQuery.isEmpty() ? base : base + "?" + newQuery;
