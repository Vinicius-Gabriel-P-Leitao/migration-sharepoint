...
/**
 * Substitui o ErrorReportValve padrão do Tomcat por uma implementação que retorna JSON.
 * Captura erros que ocorrem antes do Spring (URI malformada, erros de parse no Tomcat),
 * que não chegam ao @RestControllerAdvice nem ao CustomErrorController.
 */
@Configuration
        ...
        protected void report(Request request, Response response, Throwable throwable) {
            ...
            try {
                ...
                if (!uri.startsWith("/v1/")) {
                    ...
                    String html = "<html><head><meta http-equiv=\"refresh\" content=\"0;url=/?error_code=%d\"></head><body></body></html>"
